...
contract SetupBridgeL1 is Script {
    ...
    function run() external {
        vm.startBroadcast();
        BridgeERC721(L1_ERC721).setCounterpart(L2_ERC721);
        IL1Gateway(L1_ERC721_GATEWAY_PROXY).updateTokenMapping(L1_ERC721, L2_ERC721);
        vm.stopBroadcast();
    }
}
